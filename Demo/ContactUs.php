...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        <title>Fresh Food | Contact Us</title>
...
//            echo "</div>";
        ...
        <div id="pageContent" >
            ...
            We want to satisfy and delight our customers - every single one. We design our stores, train our Team Members and select our products with that goal in mind.<br/><br/>
            
            <h2>How Can We Help You?</h2>
            Need a refund? All refunds are handled by the store where the item was purchased. <a href="location.php" style="text-decoration:underline;">Contact your local store</a>.<br/>
            Have questions about an online order or need to make changes? <a href="location.php" style="text-decoration:underline;">Contact your local store</a>.<br/>
            Need help with a Gift card? Call 800-555-1234<br/><br/>
            
            <h2>Find Answers to Other Frequently Asked Questions</h2>
            Check out these pages for help with specific topics:<br/><br/>

            <a href="faq.php" style="text-decoration:underline;">General FAQs</a>
