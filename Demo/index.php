...
<div id="title1">
  ...
  <div id="content">
    <div id="navigationBar">
      <div id="navigationInner"> <a href="index.php" style="color:white;font-size:10pt;padding-left:10px">Home</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="AboutUs.php" style="color:white;font-size:10pt;">About Us</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="ContactUs.php" style="color:white;font-size:10pt;">Contact Us</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="faq.php" style="color:white;font-size:10pt;">FAQ</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="location.php" style="color:white;font-size:10pt;">Locations</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="Policies.php" style="color:white;font-size:10pt;">Policies</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="accountAndAdministrator/MyAccount.php" style="color:white;font-size:10pt;">My Account</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="accountAndAdministrator/SignInOrRegister.php" style="color:white;font-size:10pt;">Sign In/Register</a> 
        ...
        <div style="float: right;width: 306px">
          <form name="search" action="searchResults.php" method="get">
            <p class="keywords">
              <input type="text" name="keywords" id="keywords" maxlength="50" value="Search ..." onfocus="if (this.value == 'Search ...') {this.value = '';}" onblur="if (this.value == '') {this.value = 'Search ...';}" />
            </p>
            <p>
...
//            echo "</div>";
        ...
        ?>
    <div id="pageContent" >
      <h1>Welcome to Fresh Food!</h1>
      
                <!-- img----------------------------------------------> 
          
         <img src="fresh.jpg" height="300"  /><br /><br /><br />
      ...
      <h2>Our mission</h2>
      At Fresh Food, our mission is to bring the best ingredients from around the world, right to your doorstep. With a wide variety of authentic regional ingredients, we strive to reconnect people with flavors from around the world. </div>
